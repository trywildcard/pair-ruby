...
describe "review card from valid url metatags" do
  ...
  it "is built from json" do
    ...
    review_card.review.abstract_content.should eql 'There are a lot of smartphones out there now. You know this. To add to the confusion, many companies are now parading out multiple top-drawer phones:'
